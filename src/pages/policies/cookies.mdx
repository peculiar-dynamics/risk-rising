...
import CookiesButton from "~/components/cookies/CookiesButton.astro";
...
If you are still looking for more information then you can contact us via email: <InlineEmail email={email} subject="Website Cookie Query" />.
